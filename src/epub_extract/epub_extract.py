    ...
    try:
        ...
        if toc:
            ...
            for idx, chapter in enumerate(flat_chapters):
                chapter_title = chapter['title'] if chapter[
                    'title'] else f"Chapter {idx+1}"
            ...
            logging.info(
                f"Extracted {len(chapters)} chapters from Table of Contents.")
        ...
        if not chapters:
            ...
            logging.info(
                f"Extracted {len(chapters)} sections from document items.")
