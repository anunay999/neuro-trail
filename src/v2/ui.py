...
from v2.extractors.epub_extract import extract_epub_fn
...
class GradioUI:
    ...
    def upload_file(self, file, file_uploads_log, allowed_file_types=None):
        ...
        if file_ext == ".epub":
            ...
            epub_data = extract_epub_fn(file_path)
            ...
            retriever.add_docs_from_str(
                docs=paragraphs, metadata={"source": metadata["title"]}
            )
                ...
                with gr.Row():
                    gr.HTML(
                        """<div style="display: flex; align-items: center; gap: 8px; font-family: system-ui, -apple-system, sans-serif;">
                            <a target="_blank" href="https://github.com/anunay999/neuro-trail"><b>Neuro-Trail</b></a>
                        </div>
                        <div style="display: flex; align-items: center; gap: 8px; font-family: system-ui, -apple-system, sans-serif;">
                            <a target="_blank" href="https://github.com/huggingface/smolagents">huggingface/smolagents</a>
                        </div>
                        """
                    )
