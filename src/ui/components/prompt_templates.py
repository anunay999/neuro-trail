...
class PromptTemplateManager:
    ...
    def _initialize_state(self):
        """Initialize state variables for prompt templates."""
    ...
    def save_templates(self):
        ...
        try:
            ...
            user_templates = {
                ...
                for template_id, template in st.session_state["prompt_templates"].items()
                if not template.get("system", False)
            }
    ...
    def update_template(
        ...
        if description is not None:
            st.session_state["prompt_templates"][template_id]["description"] = description
        
        if template is not None:
            st.session_state["prompt_templates"][template_id]["template"] = template
        
        if input_variables is not None:
            st.session_state["prompt_templates"][template_id]["input_variables"] = input_variables
...
# Initialize the prompt template manager as a singleton
