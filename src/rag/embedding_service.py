...
class EmbeddingService:
    ...
    def __init__(self, ):
        ...
        logger.info(f"Initialized EmbeddingService with model {self.embedding_model_val}")
    ...
    def generate(self, texts: Union[str, List[str]]) -> np.ndarray:
        ...
        logger.info(f"Generating embeddings for {len(texts)} texts using model: {self.embedding_model.model_name}")
        ...
        try:
            ...
            st.toast(f"API Connection Error: {e}. Please check your connection and API configuration.")
            raise
